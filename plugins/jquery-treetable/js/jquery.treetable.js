  ...
  Node = (function() {
    ...
    Node.prototype.collapse = function() {
     ...
     this.row.removeClass("expanded").addClass("collapsed");
      ...
      this.expander.find('i.fa').removeClass(this.settings.expanderExpandedClass).addClass(this.settings.expanderCollapsedClass);
    ...
    Node.prototype.expand = function() {
     ...
     this.row.removeClass("collapsed").addClass("expanded");
      ...
      this.expander.find('i.fa').removeClass(this.settings.expanderCollapsedClass).addClass(this.settings.expanderExpandedClass);
  ...
  methods = {
    init: function(options, force) {
      ...
      settings = $.extend({
        ...
        expandable: false,
        expanderTemplate: "<a href='#'><i class='fa fa-lg'></i></a>",//use font awesome instead of css image backgourd
        indent: 19,
        ...
        expanderExpandedClass: "fa-caret-down",// font awesome icon css
        expanderCollapsedClass: "fa-caret-right",// font awesome icon css
        // Events
        onInitialized: null,
        onNodeCollapse: null,
        onNodeExpand: null,
