...
! function(a) {
	...
	a(function() {
		...
		c.scrollspy({
			...
			function() {
			...
			}), a(".bs-docs-popover").popover(), a("#loading-example-btn").click(function() {
				var b = a(this);
				...
				var b = a(this),
					c = b.prev(),
					d = '<div class="zero-clipboard"><span class="btn-clipboard">复制</span></div>';
		...
		d.on("ready", function() {
			e.data("placement", "top").attr("title", "复制到剪贴板").tooltip(), d.on("copy", function(b) {
				var c = a(b.target).parent().nextAll(".highlight").first();
				b.clipboardData.setData("text/plain", c.text())
			}), d.on("aftercopy", function() {
				e.attr("title", "完成复制！").tooltip("fixTitle").tooltip("show").attr("title", "复制到剪贴板").tooltip("fixTitle")
			})
		}), d.on("error", function() {
			e.attr("title", "您的浏览器需要安装 Flash 插件").tooltip("fixTitle").tooltip("show"), ZeroClipboard.destroy()
		});
